...
// Donation Closed View Component
function DonationClosedView({
  closureReason,
  locale,
}: {
    ...
    <div className="space-y-6">
      ...
      >
        <div className="p-8 md:p-12 text-center">
          ...
          >
            <p className="text-sm font-semibold text-gray-900 mb-1">{t('closed.notifyTitle')}</p>
            <p className="text-xs text-gray-500 mb-3">{t('closed.notifyDescription')}</p>
            {notifySubmitted ? (
              <div className="flex items-center justify-center gap-2 p-3 bg-emerald-50 border border-emerald-200 rounded-xl">
                ...
                <span className="text-sm text-emerald-700 font-medium">{t('closed.notifySuccess')}</span>
              </div>
            ) : (
              <div className="flex gap-2">
                <input
                  ...
                  placeholder={t('closed.notifyPlaceholder')}
                  className="flex-1 px-4 py-3 rounded-xl bg-gray-50 border border-gray-200 focus:bg-white focus:border-teal-500 focus:ring-2 focus:ring-teal-500/20 transition-all outline-none text-sm"
                />
                <button
                  onClick={() => {
                  ...
                  className="px-5 py-3 bg-gradient-to-r from-teal-600 to-emerald-600 text-white rounded-xl font-semibold text-sm hover:from-teal-700 hover:to-emerald-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-md shadow-teal-500/20 whitespace-nowrap"
                >
