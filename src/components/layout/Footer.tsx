...
export default function Footer({ contactSettings }: FooterProps) {
  ...
  const footerLinks = {
    about: [
      { name: t('links.ourStory'), href: '/about' },
      { name: t('links.leadership'), href: '/about#leadership' },
      { name: t('links.annualReports'), href: '/about#reports' },
      { name: t('links.careers'), href: '/careers' },
    ],
    programs: [
      { name: t('links.education'), href: '/projects?category=education' },
      { name: t('links.healthcare'), href: '/projects?category=healthcare' },
      { name: t('links.environment'), href: '/projects?category=environment' },
      { name: t('links.community'), href: '/projects?category=community' },
    ],
    getInvolved: [
      { name: t('links.volunteer'), href: '/contact?type=volunteer' },
      { name: t('links.partnerWithUs'), href: '/contact?type=partnership' },
      { name: t('links.events'), href: '/blog?category=events' },
    ],
    legal: [
    ...
    <footer className="bg-gradient-to-b from-foundation-charcoal to-gray-900 text-white">
      ...
      <div className="container-wide section-padding">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 lg:gap-8">
          ...
          {/* About Links */}
          <div>
            <h3 className="font-heading text-lg font-semibold mb-6 text-white">{t('about')}</h3>
          ...
          {/* Programs Links */}
          <div>
            <h3 className="font-heading text-lg font-semibold mb-6 text-white">{t('programs')}</h3>
            <ul className="space-y-3">
          ...
          {/* Get Involved Links */}
          <div>
            <h3 className="font-heading text-lg font-semibold mb-6 text-white">{t('getInvolved')}</h3>
            <ul className="space-y-3">
          ...
          {/* Newsletter */}
          <div>
            <h3 className="font-heading text-lg font-semibold mb-6 text-white">{t('stayUpdated')}</h3>
      ...
      <div className="border-t border-white/10">
        <div className="container-wide py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-gray-500 text-sm">
            &copy; {new Date().getFullYear()} Yayasan Insan Prihatin. {t('copyright')}
          </p>
